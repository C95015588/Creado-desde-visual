...
namespace MSM
{
    public partial class Administracion : Form
    {
        ...
        {
            Administracion_Certificacion_Entrenamiento PantallaAdministracionCertificionEntrenamiento = new Administracion_Certificacion_Entrenamiento();
            PantallaAdministracionCertificionEntrenamiento.Show();
            this.Close();
            this.Hide();
        }
    }
